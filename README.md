...
One suggestion though is that you probably shouldn't have printed the magic string "5:00 PM". I understand that you wanted to say that 1700 hours is 5pm, but you probably should've calculated it from 17 and then formatted the string.
_____
